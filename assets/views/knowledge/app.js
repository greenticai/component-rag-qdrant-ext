...
(function () {
  ...
  async function doIngest() {
    ...
    var wrote = false;
    try {
      // No `collection` argument, deliberately: the tool falls back to the
      // collection the operator configured. See README.md, "Collections and
      // tenancy" — the host does not stamp a tenant into tool arguments, so a
      // collection chosen in the browser would be a client-supplied target,
